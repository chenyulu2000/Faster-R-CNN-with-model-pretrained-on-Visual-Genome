...
if __name__ == '__main__':
    ...
    image_ids = []
    file_path = "imgid_list.txt"

    # Specify the file path of the HDF5 file you want to read
    origin_h5_file_path = "/home/data/visdial_v1.0_test-std/features_faster_rcnn_x101_val.h5"

    # Open the HDF5 file in read mode
    with h5py.File(origin_h5_file_path, 'r') as file:
        origin_image_ids = list(map(int, file['image_id']))
    print(origin_image_ids)

    # Open the file in write mode
    file = open(file_path, 'w')

    folder_path = "/home/data/visdial_v1.0_test-std/VisualDialog_val2018"

    for id in origin_image_ids[:32]:
        image_ids.append(
            [f'{folder_path}/VisualDialog_val2018_000000{str(id).zfill(6)}.jpg', id])
        file.write(str(id) + '\n')
    print(image_ids)
